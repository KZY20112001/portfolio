...
const experiences: Experience[] = [
  {
    ...
    description:
      "My responsibilities focused on the backend development, where I designed and implemented an in-house module that enables users to authenticate through various methods (JWTs, Session Cookies etc). Additionally, I played a pivotal role in implementing an API Gateway and other microservices using Tyk, significantly enhancing system scalability and efficiency.",
    startDate: "May 2024",
    endDate: "Aug 2024",
    techStack: [
...

  {
    ...
    startDate: "May 2023",
    endDate: "Nov 2023",
    techStack: ["Next", "Typescript", "Tailwind CSS", "DatoCMS", "GraphQL"],
